...
# 1. IMPORT THE BOTOCORE CLIENT CONFIG
...
def _s3_client():
    """Create a boto3 S3 client configured for Cloudflare R2 / MinIO."""
    return boto3.client(
        "s3",
        endpoint_url=(
        ...
        region_name="auto",    
        # FORCE BOTH S3 V4 SIGNATURES AND PATH-STYLE ADDRESSING FOR R2
        config=Config(
